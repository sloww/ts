...
class DealMasterAdmin(SelectModelAdmin):
    search_fields = ('num','p1name','p1sepc','buyer_company','owner_company', )
    list_display = ('num','buyer_company','owner_company', 'total','has_fapiao','has_pay','has_delivery','format_url', )
